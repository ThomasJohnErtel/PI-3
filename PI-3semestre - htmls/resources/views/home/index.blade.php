...
<body>
    ...
    <main>
        ...
        <img class="home-img" src="https://i.ibb.co/R32Q46t/home.png" alt="Aquarela Brinquedos">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card" id="card1">
                        <img src="https://brincamundo.com.br/wp-content/uploads/2023/05/barco-brinquedo-pista-carros-luz-acessorios.jpeg"
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <a href="#" class="card-link"><button><svg xmlns="http://www.w3.org/2000/svg" width="40"
                                            height="35" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                                            <path
                ...
                <div class="col-md-3">
                    <div class="card" id="card2">
                        <img src="https://images.tcdn.com.br/img/img_prod/841280/carrinhos_de_brinquedo_pequenos_metal_5_carros_sortidos_mini_704539_1_9a235d581e320319dc350f238710a0d0.jpg"
                            class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <a href="https://wa.me/+" class="card-link"><button><svg xmlns="http://www.w3.org/2000/svg" width="40"
                                            height="30" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                                            <path
                                                d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232" />
                                        </svg> Pagar pelo whatsapp</button></a>
                ...
                <div class="col-md-3">
                    <div class="card" id="card3">
                        <img src="https://ludopia.com.br/wp-content/uploads/2022/08/Brinquedo-terapeutico-brinquedo-de-apertar-banana-ludopia.png"
                            class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="card" id="card4">
                        <img src="https://cdn.awsli.com.br/1832/1832576/produto/90422431/e18946799a.jpg"
                            class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="card" id="card5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <a href="#" class="card-link"><button><svg xmlns="http://www.w3.org/2000/svg"
                                                width="40" height="35" fill="currentColor" class="bi bi-cart-plus"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9z" />
                                                <path
                                    ...
                                    <a href="#" class="card-link"><button><svg xmlns="http://www.w3.org/2000/svg"
                                                width="40" height="30" fill="currentColor" class="bi bi-whatsapp"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232" />
                                            </svg> Pagar pelo whatsapp</button></a>
            ...
            <div class="col-md-12 buttom-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card" id="card5">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Navio Lego</h5>
                                        <p class="card-text">Venha comprar, só hoje em promoção imperdível. Confira!
                                        </p>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">R$ 47,53 via pix</li>
                                            <li class="list-group-item"><strong>R$ 49,54</strong></li>
                                        ...
                                        <div class="card-body">
                                            <a href="#" class="card-link"><button><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="40" height="35"
                            ...
                            <div class="col-md-3">
                                <div class="card" id="card6">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Carrinho de Brinquedo</h5>
                                        <p class="card-text">venha comprar, so hoje em promoçao imperdiver confira.
                                        </p>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">R$ 90,53 via pix</li>
                                            <li class="list-group-item"><strong>R$ 49,54</strong></li>
                ...
                <div class="container">
                        ...
                        <div class="card-depoimentos">
                            ...
                            <div class="depoimento" id="depoimento1">
                                ...
                                <div class="dep-content">
                                    ...
                                    <!--Estrelas-->
                                    <img src="https://cdn.awsli.com.br/1781/1781687/arquivos/estrelas.png"
                                        class="dep-estrelas1">
                                </div>
                            </div>
                            <!--2°Depoimento-->
                    ...
                    <a href="https://wa.me/+" class="whatsapp-button" target="_blank"
                        style="position: fixed; right: 15px; bottom: 15px; z-index: 15"> <svg
                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="56" height="63"
                            viewBox="0 0 48 48">
                            <path fill="#fff"
                    ...
                    <footer class="footer-home">
                        ...
                        <p class="p-footer">Entre em contato pelo e-mail: FoxBrinquedos@Pi.com</p>
                        <nav>
                            <ul>
                                <!--Informações do footer-->
